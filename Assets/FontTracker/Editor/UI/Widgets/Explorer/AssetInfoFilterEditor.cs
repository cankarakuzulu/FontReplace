...
{
    public class AssetInfoFilterEditor : IFilterEditor<AssetInfo>
    {
        string _filter;
        
        public bool IsValid(AssetInfo value) => string.IsNullOrEmpty(_filter) || value.path.ToLower().IndexOf(_filter.ToLower()) >= 0;
